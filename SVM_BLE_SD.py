...
names = ['rssi1', 'rssi2', 'rssi_sd','rssi_wifi','25_area','10_area','2_area','trajectory','3_area']
data_set = pd.read_csv("C:/Thesis/data/default_ble_and_smart_device.csv", names=names)
print(data_set.head())
